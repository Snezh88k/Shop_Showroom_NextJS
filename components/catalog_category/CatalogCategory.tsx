    ...
    <>
      ...
      <li>
        <Link href={`/${lng}/catalog/tops_shirts`}>
          {t("category_tops_and_shirts")}
        </Link>
      </li>
      <li>
        <Link href={`/${lng}/catalog/dresses_skirts`}>
          {t("category_dresses_and_skirts")}
        </Link>
      </li>
      <li>
        <Link href={`/${lng}/catalog/pants_jeans`}>
          {t("category_pants_and_shorts")}
        </Link>
      </li>
      <li>
        <Link href={`/${lng}/catalog/suits_sets`}>
          {t("category_suits_and_sets")}
        </Link>
      </li>
    </>
  );
